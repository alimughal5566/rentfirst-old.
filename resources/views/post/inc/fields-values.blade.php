@if (isset($customFields) and $customFields->count() > 0)
    <div class="row" id="customFields">
        ...
        {{--                <div class="col-12 pb-2 pl-1 pr-1">--}}
        ...
        <div class="col-12">
            <div class="row pl-2 pr-2">
                @foreach($customFields as $field)
                    ...
                    ?>
                    @if ($field->type == 'file')
                        <div class="detail-line col-12 pb-2 pl-1 pr-1">
                            <div class="detail-line-inner rounded-small d-flex justify-content-between align-items-center ml-0 mr-0 p-2">
                    ...
                    @else
                        @if (!is_array($field->default))
                            <div class="detail-line col-sm-6 col-12 pb-2 pl-1 pr-1">
                                <div class="detail-line-inner rounded-small d-flex justify-content-between align-items-center p-2">
