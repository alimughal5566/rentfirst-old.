        ...
        <div class="user-panel-sidebar">
                    ...
                    <ul class="acc-list">
                        <li>
                            <a {!! ($pagePath=='') ? 'class="active"' : '' !!} href="{{ lurl('account') }}">
                                <span><i class="icon-home"></i> {{ t('Personal Home') }}</span>
                            </a>
                        </li>
                    </ul>
                </div>
            ...
            <div class="collapse-box">
                <h5 class="collapse-title">
                    {{ t('My Ads') }}
                    <a href="#MyAds" data-toggle="collapse" class="pull-right">
                    ...
                    <ul class="acc-list">
                        <li>
                            <a {!! ($pagePath=='my-posts') ? ' class="active"' : '' !!} href="{{ lurl('account/my-posts') }}">
                                <span><i class="icon-docs"></i> {{ t('My ads') }}&nbsp;</span>
                        ...
                        <li>
                            <a {!! ($pagePath=='favourite') ? ' class="active"' : '' !!} href="{{ lurl('account/favourite') }}">
                                <span><i class="icon-heart"></i> {{ t('Favourite ads') }}&nbsp;</span>
                                <span class="badge badge-pill">
                        ...
                        <li>
                            <a {!! ($pagePath=='saved-search') ? ' class="active"' : '' !!} href="{{ lurl('account/saved-search') }}">
                                <span><i class="icon-star-circled"></i> {{ t('Saved searches') }}&nbsp;</span>
                                <span class="badge badge-pill">
                        ...
                        <li>
                            <a {!! ($pagePath=='pending-approval') ? ' class="active"' : '' !!} href="{{ lurl('account/pending-approval') }}">
                                <span><i class="icon-hourglass"></i> {{ t('Pending approval') }}&nbsp;</span>
                                <span class="badge badge-pill">
                        ...
                        <li>
                            <a {!! ($pagePath=='archived') ? ' class="active"' : '' !!} href="{{ lurl('account/archived') }}">
                                <span><i class="icon-folder-close"></i> {{ t('Archived ads') }}&nbsp;</span>
                                <span class="badge badge-pill">
                        ...
                        @if (config('plugins.apilc.installed'))
                            <li>
                                <a {!! ($pagePath=='api-dashboard') ? ' class="active"' : '' !!} href="{{ lurl('account/api-dashboard') }}">
                                    <span><i class="icon-cog"></i> {{ trans('api::messages.Clients & Applications') }}&nbsp;</span>
                                </a>
                            </li>
                        @endif
                    </ul>
            ...
            <div class="collapse-box">
                <h5 class="collapse-title">
                    {{ t('Terminate Account') }}&nbsp;
                    <a href="#TerminateAccount" data-toggle="collapse" class="pull-right">
                        <i class="fa fa-angle-down"></i>
                    </a>
                </h5>
                    ...
                    <ul class="acc-list">
                        <li>
                            <a {!! ($pagePath=='close') ? 'class="active"' : '' !!} href="{{ lurl('account/close') }}">
                                <span><i class="icon-cancel-circled "></i> {{ t('Close account') }}</span>
                            </a>
                        </li>
                    </ul>
                </div>
